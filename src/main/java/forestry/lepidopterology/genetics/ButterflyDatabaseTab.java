...
public class ButterflyDatabaseTab implements IDatabaseTab<IButterfly> {
	...
	@Override
	public void createElements(IGuiElementGenetic container, IButterfly butterfly, ItemStack itemStack) {
		...
		container.text(TextFormatting.UNDERLINE + Translator.translateToLocal("for.gui.diurnal"), GuiElementAlignment.CENTER);
