...
public interface IAlyzerPlugin {
	 ...
	 */
	default void createFirstPage(GuiScreen gui, IGuiElementGenetic container, IIndividual individual){
	}
	 ...
	 * @param individual The individual that is currently in the alyzer slot.
	 */
	default void createSecondPage(GuiScreen gui, IGuiElementGenetic container, IIndividual individual){
	}
	 ...
	 * @param individual The individual that is currently in the alyzer slot.
	 */
	default void createThirdPage(GuiScreen gui, IGuiElementGenetic container, IIndividual individual){
	}
