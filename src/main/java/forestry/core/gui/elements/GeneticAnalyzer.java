...
public class GeneticAnalyzer extends ElementContainer implements IGeneticAnalyzer, IScrollable {
	/* Textures */
	...
	public GeneticAnalyzer(int xPos, int yPos, boolean rightBoarder, IGeneticAnalyzerProvider provider) {
		super(xPos - (rightBoarder ? 6 : 0), yPos, 189 + (rightBoarder ? 6 : 0), 166);
	...
	public void draw(int startX, int startY, int mouseX, int mouseY) {
		...
		super.draw(startX, startY, mouseX, mouseY);
	}
