...
public class ProductsTab extends DatabaseTab {
	...
	public void createElements(IGuiElementGenetic container, IIndividual individual, ItemStack itemStack) {
		...
		if(!products.isEmpty()) {
			container.text(Translator.translateToLocal("for.gui.beealyzer.produce"), GuiElementAlignment.CENTER);
		...
		container.text(Translator.translateToLocal("for.gui.beealyzer.specialty"), GuiElementAlignment.CENTER);
